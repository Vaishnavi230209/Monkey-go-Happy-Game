...
function draw()
{
  ...
  if(gameState===START)
  {
   ...
   fill("red");
   textSize(20);
   text("Instructions for playing the game:-",50,80);
   fill("blue");
   textSize(18);
   text("1.Press Space Key to Start the Game",50,110);
   fill("green");
   text("2.Press Space Key to Jump",50,135);
   text("3. Press UP Arrow Key for long jump",50,160);
  text ("4.Collect the fruits to increase the score",50,185);
   fill ("black")
    textSize(30);
